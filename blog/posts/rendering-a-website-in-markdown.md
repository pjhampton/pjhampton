...
For this incredibly simple non-prolific blog with hundreds of hits a week, the answer is yes. The source was already there, so the feature amounted to some generated files, a small decision at the edge and tests around the awkward bits. People still get the website I designed for them. Agents can get the words without the noise. I'm excited to see how agents influence the deployment of websites and applications over the next decade.
